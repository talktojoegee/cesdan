    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand d-md-none" href="#">
                <img src="/assets/images/brand/cidsan-logo.png" class="header-brand-img mobile-icon" alt="logo">
                <img src="/assets/images/brand/cidsan-logo.png" class="header-brand-img desktop-logo mobile-logo" alt="logo">
            </a>
            ...
            <div class="d-flex ml-auto header-right-icons header-search-icon">
                ...
                <div class="dropdown d-none d-md-flex message">
                    <a class="nav-link icon text-center" data-toggle="dropdown">
                        <i class="ti-bell"></i>
                        <span class="nav-unread badge badge-danger badge-pill pulse">{{Auth::user()->getTenantNotifications->count()}}</span>
                    </a>
                    @if(Auth::user()->getTenantNotifications->count() > 0)
