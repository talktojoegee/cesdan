                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="text-white">
                            <h2 class="mb-0 number-font">{{number_format($invoices->sum('paid_amount'),2)}}</h2>
                            <p class="text-white mb-0">Invoice</p>
                        </div>
        ...
        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
            <div class="card  bg-success img-card box-success-shadow">
                <div class="card-body">
                    <div class="d-flex">
                        <div class="text-white">
                            <h2 class="mb-0 number-font">{{number_format($receipts->sum('amount'),2)}}</h2>
                            <p class="text-white mb-0">Receipt</p>
                        </div>
                        <div class="ml-auto"> <i class="ti-wallet text-white fs-30 mr-2 mt-2"></i> </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-12 col-sm-12">
                        <h4>Filter</h4>
                        <form action="{{route('filter-sales-report', ['account'=>$account])}}" class="form-inline" method="get">
                            @csrf
                    ...
                    <div class="col-md-12 mt-4">
                        <h5 class="text-uppercase mt-4 "> <strong>Sales Report</strong> <small>(Inflow)</small>
