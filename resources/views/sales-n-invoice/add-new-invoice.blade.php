        ...
        <div class="col-md-12">
            <div class="card">
                <div class="">
                    ...
                    @endif
                    <div class="card-body">
                        <form action="{{route('add-new-invoice', ['account'=>$account])}}" method="post">
                            @csrf
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="mb-0 card-title">Issue Invoice</h3>
                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="contact_type" id="contact_type" class="form-control">
                                                    ...
                                                    <option value="2">Existing Contact</option>
                                                </select>
                                                @error('contact_type') <i class="text-danger">{{$message}}</i>@enderror
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <button class="btn btn-primary" type="button">Issue Date</button>
                ...
                <div class="modal-body">
                    <div class="card-body">
                        <form action="{{route('add-new-contact', ['account'=>$account])}}" method="post">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="mb-0 card-title">Add New Contact</h3>
                                </div>
                                <div class="card-alert alert alert-success mb-0">
                                    Company Info
                                </div>
